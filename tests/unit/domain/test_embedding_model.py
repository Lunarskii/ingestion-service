...
class TestEmbeddingModel:
    ...
    async def test_encode_returns_list_float(
        ...
        embedding: list[float] = embedding_model.encode("some string")
    ...
    async def test_encode_returns_ndarray(
        ...
        embeddings: numpy.ndarray = embedding_model.encode(
            [
                "some string",
                "some string",
                "some string",
    ...
    async def test_encode_returns_vectors(
        ...
        for vector in vectors:
            ...
            for value in vector.values:
                assert isinstance(value, float)
            assert isinstance(vector.payload, VectorPayload)
